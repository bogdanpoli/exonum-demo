...
public abstract class SeleniumFunctions {
	...
	protected void waitForElementIsInvisible(final WebElement element) {
	...
	protected void click(final WebElement element) {
		final Actions builder = new Actions(this.driver);
		final Action click = builder.click(element).build();
		click.perform();
	}
	...
	protected void waitAndClickElement(final WebElement element) {
		waitForElement(element);
